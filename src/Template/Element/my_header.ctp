  ...
  <nav class="Navigation">
    <div class="NavigationBox">
      ...
      <ul class="NavigationList">
        ...
        <li class="NavigationItems" id="Mypage"><?= $this->Html->link('Mypage',['controller' => 'users','action' => 'edit',$user_id]) ?></li>
        <?php endif; ?>
        <li class="NavigationItems" id="Login"><?= $this->Html->link('Login',['controller'=>'users','action'=>'login']) ?></li>
        <li class="NavigationItems" id="Logout"><?= $this->Html->link('Logout',['controller'=>'users','action'=>'logout']) ?></li>
